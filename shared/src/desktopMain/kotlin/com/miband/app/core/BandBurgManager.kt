...
actual class BandBurgManager {
    actual fun init() {}
    actual suspend fun connect(name: String, addr: String, authkey: String, connectType: Int): DeviceSession = throw UnsupportedOperationException("Desktop not supported")
